learScript = "SCENE I. King Lear's palace.
...
allLines = learScript.split("\n")

def findCordelia(allLines)
	cordeliaCounter = 0
	for i in 0..allLines.length-1
		if allLines[i] === "CORDELIA"
			cordeliaCounter +=1
		end
	end
	return cordeliaCounter
end

cordeliaTimes = findCordelia(allLines)
puts cordeliaTimes
